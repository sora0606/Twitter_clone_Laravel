    ...
    <div class="flex-area">
        ...
        <div class="sideber-nav">
            <div class="side-inner">
                <ul class="nav">
                    <li class="nav-item"><a href="{{url('home')}}"></a><img src="{{asset('img/twitter-icon.svg')}}" alt=""></li>
                    ...
                    <h1>ホーム</h1></li>
                    <li class="nav-item"><a href="{{url('serach')}}"></a>
                    <span>
                    ...
                    <h1>検索</h1></li>
                    <li class="nav-item"><a href="{{url('notification')}}"></a>
                    <span>
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        width="655.715px" height="655.715px" viewBox="0 0 655.715 655.715" style="enable-background:new 0 0 655.715 655.715;"
                        xml:space="preserve">
                        <g>
                            <g id="_x36__27_">
                                <g>
                    ...
                    <h1>通知</h1></li>
                    <li class="nav-item"><a href="{{url('message')}}"></a>
                    <span>
                    ...
                    <h1>メッセージ</h1></li>
                    <li class="nav-item"><a href="{{url('profile')}}"></a>
                    <span>
                    ...
                    <li class="user-nav"><a href=""></a>
                        ...
                        <img src="{{asset('img/more.svg')}}" alt="" class="dot">
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="timeline">
            <div class="serach">
                <form action="" method="post">
                    <button type='submit' class="btn"><img src="{{asset('img/loupe.svg')}}" alt=""></button>
                    <input type="text" placeholder="キーワード検索" name="keyword" class="serach-input" value="">
                </form>
            </div>
        </div>
